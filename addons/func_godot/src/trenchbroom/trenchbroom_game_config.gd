...
@export var fgd_file : FuncGodotFGDFile = preload("res://entities/config/entities/fgd.tres")
...
@export var brushface_tags : Array[Resource] = [
	preload("res://entities/config/trenchbroom/face_clip.tres"),
	preload("res://entities/config/trenchbroom/face_skip.tres"),
	preload("res://entities/config/trenchbroom/face_origin.tres")
]
