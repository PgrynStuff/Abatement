...
func _enter_tree() -> void:
	...
	ProjectSettings.set("func_godot/default_map_settings", "res://entities/config/map_settings.tres")
	var property_info = {
	...
	ProjectSettings.set_initial_value("func_godot/default_map_settings", "res://entities/config/map_settings.tres")
