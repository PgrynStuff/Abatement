...
@export var entity_fgd: FuncGodotFGDFile = preload("res://entities/config/entities/fgd.tres")
...
@export var default_material: Material = preload("res://common/textures/default.tres")
